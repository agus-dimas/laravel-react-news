    ...
    <div class="flex min-h-screen bg-zinc-100">
        <aside class="w-72 bg-[#b3181f] text-white px-6 py-8 hidden lg:block">
            ...
            <nav class="mt-8 space-y-2 text-sm">
                ...
                <a href="{{ route('dashboard.users.index') }}" class="block rounded-lg px-3 py-2 bg-white/15">Manajemen User</a>
            </nav>
        </aside>
                ...
                <div class="mt-6 grid gap-6 lg:grid-cols-2">
                    <div class="rounded-2xl bg-white shadow p-6">
                        ...
                        <form action="{{ route('dashboard.users.store') }}" method="POST" class="space-y-4">
                            ...
                            <button type="submit"
                                class="inline-flex items-center rounded-lg bg-[#b3181f] px-4 py-2 text-sm font-semibold text-white shadow hover:bg-[#99141b]">Simpan Admin</button>
                        </form>
                    </div>
