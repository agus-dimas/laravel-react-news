export function Footer() {
    return (
        <footer class="border-t border-white/10 bg-gradient-to-br from-[#09090a] via-[#111113] to-[#1a0d10] text-zinc-200">
            <div class="mx-auto max-w-7xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        <div>
                            <img src="/images/update%20logo/Logo%20Partai%20Garuda%20-hitam%20putih.png" alt="Logo Partai Garuda" class="h-10 w-auto object-contain" />
                        </div>

                        <p class="mt-4 max-w-xs text-zinc-400">
                    ...
                    <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
                        <div>
                            ...
                            <ul class="mt-6 space-y-4 text-sm">
                                <li>
                                    <a href="#" class="text-zinc-300 transition hover:text-red-400"> </a>
                                </li>
                ...
                <p class="border-t border-white/10 pt-6 text-xs text-zinc-400">© 2026 Partai Garda Republik Indonesia. All rights reserved.</p>
            </div>
        </footer>
    );
}
